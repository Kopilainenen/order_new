...
<table border="0" cellspacing="0" cellpadding="1" class="register_form">
        <tr>
                    ...
                    <table class="sale_order_full_table">
                        ...
                        <tr>
                            <td nowrap align="center">
                                <input type="submit" value="<? echo GetMessage("STOF_NEXT_STEP") ?>" class="add_recipe">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="form__checkbox_container">
                                        <input type="hidden" name="PERSONAL_DATA_CONFIRM" id="PERSONAL_DATA_CONFIRM" value="off"/>
                                        <input type="checkbox" name="PERSONAL_DATA_CONFIRM" id="PERSONAL_DATA_CONFIRM"
                                        <? if ($arResult["POST"]["PERSONAL_DATA_CONFIRM"] == 'on') echo 'checked="checked"'; ?>
                                               />
                                    </div>
                                    <div class="form__rules_container">
                                        <?
                                        if (SITE_ID == 's3')
                                            $path = "/include_areas/confurm_person.php";
                                        else
