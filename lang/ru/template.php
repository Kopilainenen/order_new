...
$MESS ['SOA_TEMPL_ORDER_SUC_N'] = "Ваш заказ <b>№#ORDER_ID#</b> от #ORDER_DATE# не оплачен.";
$MESS ['SOA_TEMPL_ORDER_SUC_PAY'] = "Ваш заказ <b>№#ORDER_ID#</b> от #ORDER_DATE# успешно оплачен.";
$MESS ['SOA_TEMPL_ORDER_SUC1'] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\" style='    font-weight: bold;
    font-size: 16px;
    text-decoration: underline;'>Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";

$MESS ['SOA_TEMPL_ORDER_SUC2'] = "Вы сможете забрать заказ в выбранном Вами магазине <b>#ADDRESS#</b>, магазин Петровский при получении смс сообщения о готовности
выдачи, но не ранее чем через 2 часа от оформления заказа.";
$MESS ['SOA_TEMPL_ORDER_SUC2_1'] = "Важно - заказ будет хранится в магазине до <b>21:00 / #DATE#</b>";
$MESS ['SOA_TEMPL_ORDER_SUC2_2'] = "При получении заказа в магазине - назовите номер Вашего заказа - <b>№#ORDER_ID#</b>";
